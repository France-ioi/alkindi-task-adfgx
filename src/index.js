...
export const Workspace = EpicComponent(self => {

   self.render = function () {
      const {task, workspace, dispatch} = self.props;
      const rootScope = {
         ...task,
         clearAlphabet,
         adfgxAlphabet,
      ...
      return <WorkspaceManager.View workspace={workspace} rootScope={rootScope} dispatch={dispatch}/>;
   };
